      ...
      {isLoading ? (
        ...
        >
          {(activeTab === 'all' || activeTab === 'people') && results.users.length > 0 && (
            <div className="mb-8">
              <h2 className="text-lg font-semibold mb-4 dark:text-white">People</h2>
          ...
          {(activeTab === 'all' || activeTab === 'hashtags') && results.hashtags.length > 0 && (
            <div className="mb-8">
              <h2 className="text-lg font-semibold mb-4 dark:text-white">Posts with Hashtags</h2>
              <div className="space-y-4">
          ...
          {!isLoading && query && Object.values(results).every(arr => arr.length === 0) && (
