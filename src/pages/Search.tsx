...
export default function Search() {
  ...
  return (
    <div className="min-h-screen w-screen max-w-full overflow-x-hidden bg-gray-50 dark:bg-amoled py-8">
      <form onSubmit={handleSearch} className="mb-8 w-full max-w-full overflow-x-hidden">
        <div className="relative w-full max-w-full overflow-x-hidden">
          <input
            ...
            className="w-full max-w-full px-4 py-3 pl-12 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-white"
            style={{ fontSize: '16px' }}
          />
      ...
      <div className="mb-6 w-full max-w-full overflow-x-hidden">
        <div className="border-b dark:border-gray-700 w-full max-w-full overflow-x-hidden">
          <nav className="flex space-x-8 w-full max-w-full overflow-x-auto">
